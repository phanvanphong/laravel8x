...
<div id="contact-page" class="container">
        ...
        <div class="row">
        <div class="col-sm-4">
            <img src="{{URL::to('public/frontend/images/a33.png')}}" alt="" style = "width:100%;">
        </div>
        <div class="col-sm-8">

        <div class="row">
            <div class="col-sm-12">
                        <h2 class="title">TẤT TẦN TẬT <strong>VỀ HỆ THỐNG BIGSHOES</strong></h2> 
...
Chính thức hoạt động từ năm 2015, đi cùng những cố gắng và nỗ lực không ngừng nghỉ, đến thời điểm hiện tại, BIGSHOES đã đánh dấu mình vào một vị trí vững chắc trong văn hóa thời trang & sneakers ở thị trường miền Trung vốn còn non trẻ này. 2 năm xây dựng và phát triển, 2 cửa hàng, showroom được ra đời, đều nằm trong các khu vực trung tâm thuộc thành phố Đà Nẵng và thành phố Tam Kỳ. Thời gian sắp tới, BIGSHOES sẽ tiếp tục mở rộng thêm một chi nhánh nữa đặt tại “phố thời trang” – Lê Duẩn – Đà Nẵng. Ngay bây giờ, hãy cùng tìm hiểu vài nét sơ lược về cả 3 chi nhánh “to bự” này nhé!</p>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/freeship.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/new1.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
...
Sản phẩm tại shop đảm bảo là sản phẩm mới 100% và được nhập khẩu từ các nhãn hàng uy tín trên toàn quốc và trên thế giới.</div>
                ...
                <div class="row">
                <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/chinhhang.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/doitra.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
...
Shop có chính sách đổi trả trong vòng 7 ngày đối với những khách hàng có nhu cầu đổi trả sản phẩm 1 cách nhanh chóng và tận tình</div>
                ...
                <div class="row">
                    <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/cskh.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
...
Chế độ chăm sóc khách hàng tại shop tận tình , nhiệt tình hỗ trợ và phục vụ quý khách chu đáo.Đáp ứng nhu cầu của mọi khách hàng ! </div>
                ...
                <div class="row">
                <div class="col-sm-2"><img src="{{URL::to('public/frontend/images/thanhtoan.jpg')}}" alt="" style = "width:80px;"></div>
                    <div class="col-sm-10">
